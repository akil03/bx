...
//	}
	...
	{
		return PhotonNetwork.inRoom && PhotonNetwork.room.PlayerCount==maxplayers && roomStatus==ConnectionStatus.connected ;
	}
	...
	public IEnumerator _ConnectToMaster(ParameterlessDelegate success=null,ParameterlessDelegate failed=null)
	{
		...
		else if(serverStatus == ConnectionStatus.failed || serverStatus == ConnectionStatus.disconnected)
		{
			...
			if (!InternetChecker.instance.reconnect) 
			{
				...
				ChallengeWindowGUI.instance.matchLoading.Hide (true);
			}
		}
	}
...
//		print (cause.ToString());
	...
	public void CloseUP()
	{
		ChallengeWindowGUI.instance.challenge = null;
	...
	public void RebootConnection()
	{
		...
		if (ChallengeWindowGUI.instance.matchLoading.isActiveAndEnabled)
			ChallengeWindowGUI.instance.matchLoading.Hide (false);
